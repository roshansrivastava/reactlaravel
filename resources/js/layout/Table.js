          ...
          <table id="users-list-datatable" className="table">
            ...
            <tbody>
              <tr>
                ...
                <td>No</td>
                <td>Staff</td>
                <td><span className="chip green lighten-5">
                    <span className="green-text">Active</span>
                  </span>
                </td>
                <td><a href="page-users-edit.html"><i className="material-icons">edit</i></a></td>
                <td><a href="page-users-view.html"><i className="material-icons">remove_red_eye</i></a></td>
              </tr>
              <tr>
                <td></td>
                <td>301</td>
              ...
              <tr>
                ...
                <td>No</td>
                <td>Staff</td>
                <td><span className="chip red lighten-5"><span className="red-text">Banned</span></span></td>
                <td><a href="page-users-edit.html"><i className="material-icons">edit</i></a></td>
                <td><a href="page-users-view.html"><i className="material-icons">remove_red_eye</i></a></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>No</td>
                <td>Staff</td>
                <td><span className="chip orange lighten-5"><span className="orange-text">Close</span></span></td>
                <td><a href="page-users-edit.html"><i className="material-icons">edit</i></a></td>
                <td><a href="page-users-view.html"><i className="material-icons">remove_red_eye</i></a></td>
              </tr>
              <tr>
