<header class="page-topbar" id="header">
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
            ...
            <ul class="navbar-list right">
              ...
              <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="/css/images/avatar/avatar-7.png" alt="avatar"><i></i></span></a></li>
    ...
    <ul class="display-none" id="default-search-main">
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img src="/css/images/icon/pdf-image.png" width="24" height="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img src="/css/images/icon/doc-image.png" width="24" height="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img src="/css/images/icon/xls-image.png" width="24" height="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img src="/css/images/icon/jpg-image.png" width="24" height="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img class="circle" src="/css/images/avatar/avatar-7.png" width="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img class="circle" src="/css/images/avatar/avatar-8.png" width="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img class="circle" src="/css/images/avatar/avatar-10.png" width="30" alt="sample image"></div>
      ...
      <li class="auto-suggestion"><a class="collection-item" href="#">
          <div class="display-flex">
            <div class="display-flex align-item-center flex-grow-1">
              <div class="avatar"><img class="circle" src="/css/images/avatar/avatar-12.png" width="30" alt="sample image"></div>
              <div class="member-info display-flex flex-column"><span class="black-text">Anna Strong</span><small class="grey-text">Web Designer</small></div>
            </div>
          </div></a></li>
    </ul>
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img class="hide-on-med-and-down" src="/css/images/logo/materialize-logo-color.png" alt="materialize logo"/><img class="show-on-medium-and-down hide-on-med-and-up" src="/css/images/logo/materialize-logo.png" alt="materialize logo"/><span class="logo-text hide-on-med-and-down">Materialize</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
      </div>
         ...
         <div class="card recent-buyers-card animate fadeUp">
            <div class="card-content">
               ...
               <ul class="collection mb-0">
                  <li class="collection-item avatar">
                     <img src="/css/images/avatar/avatar-7.png" alt="" class="circle" />
                  ...
                  <li class="collection-item avatar">
                     <img src="/css/images/avatar/avatar-3.png" alt="" class="circle" />
                     <p class="font-weight-600">Adam Garza</p>
                     <p class="medium-small">20, January 2019</p>
                     <a href="#!" class="secondary-content"><i class="material-icons">star_border</i></a>
                  </li>
                  <li class="collection-item avatar">
                     <img src="/css/images/avatar/avatar-5.png" alt="" class="circle" />
    ...
    <li class="chat-body">
      <ul class="collection">
        <li class="collection-item display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
          <span class="avatar-status avatar-online avatar-50"><img src="/css/images/avatar/avatar-7.png"
              alt="avatar" />
          </span>
                ...
                <div class="modal-content">
                    ...
                    <div class="carousel carousel-slider center intro-carousel">
                        ...
                        <div class="carousel-item slide-1">
                            <img src="/css/images/gallery/intro-slide-1.png" alt="" class="responsive-img animated fadeInUp slide-1-img">
                        ...
                        <div class="carousel-item slide-2">
                            <img src="/css/images/gallery/intro-features.png" alt="" class="responsive-img slide-2-img">
                        ...
                        <div class="carousel-item slide-3">
                            <img src="/css/images/gallery/intro-app.png" alt="" class="responsive-img slide-1-img">
